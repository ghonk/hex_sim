...
buttons     = []
button_text = []
button_pos  = [[0, 200], [-90, -125], [90, -125], [-185, 12.5], [185, 12.5], [0, 25]]
fill_colors = [[1, 1, 1], init_button_color, init_button_color, 
	init_button_color, init_button_color, init_button_color]
